...
# CONCLUSION: La librería requests nos permite actuar como un navegador desde el código, automatizando la interacción con servicios web de forma externa.
...
# CONCLUSION: Hemos cerrado el ciclo de comunicación entre dos aplicaciones independientes, logrando que un cliente controle y gestione datos de un servidor mediante protocolos estándar de internet.
