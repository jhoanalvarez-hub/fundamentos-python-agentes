...
if __name__ == "__main__":
    ...
    # CONCLUSION: Sin un sistema de almacenamiento, los datos mueren al cerrar el programa; necesitamos persistencia.
    ...
    # CONCLUSION: SQLite guarda la información de forma estructurada y segura en un archivo físico fuera de la memoria RAM.
    ...
    # CONCLUSION: Las llaves primarias aseguran que no haya duplicados, manteniendo el orden y la identidad única de cada registro.
    ...
    # CONCLUSION: Leer datos de la base de datos permite recuperar la información exactamente como la dejamos anteriormente.
    ...
    # CONCLUSION: El uso de IDs automáticos y marcas de tiempo nos ayuda a organizar eventos en el orden exacto en que ocurrieron.
    ...
    # CONCLUSION: Las consultas filtradas permiten extraer solo la información relevante para un usuario u objetivo específico.
    ...
    # CONCLUSION: Integrar bases de datos transforma programas temporales en aplicaciones capac